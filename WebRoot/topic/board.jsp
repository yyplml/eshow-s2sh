						...
						<div class="fullWidth">
							...
							<div class="skyWrap">
								...
								<div class="forumview">
									<table cellpadding="0" cellspacing="0" class="forumtable"
										...
										<s:iterator value="%{#topicList.topics}" status="rowStatus">
											<tr
												...
												<td class="threadTitle"><a
													href="<c:url value='/topic/view/${id}'/>"
													style="color: #0187c5; text-decoration: none;">${util:preview(title,50)}
												</a> &nbsp;</td>
												<td class="numReplies">${board.name}</td>
												<td class="threadAuthor"><a
													href="<c:url value='/user/view?id=${user.id}'/>"
													style="color: #0187c5; text-decoration: none;">${user.nickname}
												</a></td>
												<td class="numReplies">${commentSize}</td>
												<td class="numViews">${count}</td>
												<td class="lastPost"><small><s:date
															name="addTime" format="yyyy-MM-dd HH:mm" /> </small></td>
											</tr>
										</s:iterator>
									</table>
									...
									<div class="infoBox">
										您必须在登录后操作。 <a href="<c:url value='/login'/>"
											style="text-decoration: none"><font
											style="color: #0187c5; text-decoration: none;">登录</font> </a>到或 <a
											href="<c:url value='/signup'/>" style="text-decoration: none"><font

					...
					<div id="content" class="narrowcolumn"
						...
						<div class="post" id="post-1920" style="margin-top: -20px;">
							...
							<s:iterator value="%{#blogList.blogs}" status="rowStatus">
								...
								<small style="color: #23a726"> <s:date name='%{addTime}'
										format='yyyy-MM-dd' /> by ${user.username} 分类:${category.name}
								</small>
								<br />
								<div class="entry">
					...
					<div id="sidebar">
						<ul>
							...
							<li class="pagenav">
								...
								<ul>
									<li>
										<a href="<c:url value='/blog'/>" class="lnk1"
											style="margin-left: -5px;"><font color="#23a726;">全部日志</font>
										</a>
									</li>
									...
									<s:iterator value="%{#categoryList.categories}"
										...
										<li class="page_item page-item-654">
											<c:if test="${categoryList.category.id == id}">
												<a href="<c:url value='/blog/category/${id}'/>" class="lnk1"><font

...
<div class="container">
    <div class="row">
        <div class="span8">
			...
			<div class="post">
			<h3 class="yahei"><a href="<c:url value='/blog/view/${id}'/>">${title}</a></h3>
              <ul class="post-meta clearfix">
                 <li>
                    <i class="icon-calendar"></i>
                    <a href=""><s:date name='%{addTime}' format='yyyy-MM-dd' /></a>
                  </li>
                <li>
                    <i class="icon-user"></i>
				...
				<div class="text">
					${util:preview(content,300)}&nbsp;&nbsp;&nbsp;&nbsp; <small
						style="color: #"> <font color="#23a726">
						<a href="<c:url value='/blog/view/${id}'/>" class="lnk1">阅读更多</a>
					</font> </small> <br />
				</div>
				</div>
					</s:iterator>

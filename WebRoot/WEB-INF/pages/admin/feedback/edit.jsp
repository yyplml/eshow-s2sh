				...
				<div id="content">
					...
					<div id="mainTab">
						<ul>
							...
							<li class="on">
								<span class="txt6"><a>修改留言</a> </span>
							</li>
							<li class="navtxt">
								<a href="<c:url value='/admin/feedback/add'/>">添加留言</a>
							</li>
						</ul>
					</div>
					<div id="edit">
						<s:form id="feedbackForm" action="feedback!update" method="post">
							...
							<p>
								...
								<span class="r">&nbsp; <input name="feedback.username"
										...
										value="${view.feedback.username}" /> </span>
							</p>
							<p>
								...
								<span class="r">&nbsp; <input name="feedback.title"
										class="inputtext" style="width: 200px;" maxlength="50"
										type="text" onblur="this.className='inputtext'"
										value="${view.feedback.title}" /> </span>
							</p>
							<p>
								<span class="l">留言内容:&nbsp;</span>
								<span class="r">&nbsp;&nbsp;<textarea
										style="width: 400px; height: 80px;" name="feedback.content"
										id="inputBox" onkeyup="keyup(200)" cols="" rows=""
										onblur="this.className='textarea'"
										onfocus="this.className='textarea2'">${view.feedback.content}</textarea>
								</span>
							</p>
							<div class="c"></div>
							<div class="c h5"></div>

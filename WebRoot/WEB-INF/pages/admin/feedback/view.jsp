				...
				<div id="content">
					...
					<div id="feedback${view.feedback.id}">
						<div id="mainTab">
							<ul>
								<li class="text">
									<span><a href="<c:url value='/admin/feedback'/>">留言列表</a>
									</span>
								</li>
								<li class="on">
									<span class="txt6"><a>留言信息</a> </span>
								</li>
								<li class="navtxt">
						...
						<div id="view">
							...
							<div class="comment_textarea" id="replay">
								<s:form action="feedback!reply.html" id="feedbackForm"
									method="post">
									<input type="hidden" name="id" value="${view.feedback.id}" />
									<br />
									<br />
									<div>

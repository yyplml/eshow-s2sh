...
<body>
			...
			<div class="slide-content" timer="7000">
				<div class="slide-item visible">
					<div class="slide-image">
						<b
							style="background-image: url(./images/banner_01.jpg); background-size: cover;"
				...
				<div class="slide-item">
					<div class="slide-image">
						<b
							style="background-image: url(./images/banner_02.jpg); background-size: cover;"
							class="sl-img "></b>
					</div>
				</div>
			</div>
	...
	<div class="features wapper clearfix">
		<ul class="">
			<li><img class="b_ic_a" src="./images/tra.gif">
				<h3 class="yahei">最新动态</h3>
				<p>目前公司正在提供语音/照片/视频领域的移动互联网解决方案</p> <a href="">查看全文</a>
			</li>
			<li><img class="b_ic_b" src="./images/tra.gif">
				<h3 class="yahei">技术驱动</h3>
				<p>公司拥有资深架构师，公司80%的人员都是技术人才，我们是一家专注于技术的公司</p> <a href="">查看全文</a>
			</li>
			<li><img class="b_ic_c" src="./images/tra.gif">
				<h3 class="yahei">联系方式</h3>
				<p>我们在太湖科教园沏一杯茶，等您，直接电话136-5617-1020</p> <a
				href="contact">查看全文</a></li>
			<li class="end"><img class="b_ic_d" src="./images/tra.gif">

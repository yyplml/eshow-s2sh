...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript"
			src="<c:url value='/scripts/mootools-1.2.4-core-yc.js'/>"></script>
		<script type="text/javascript"
			src="<c:url value='/scripts/mootools-1.2.4.2-more.js'/>"></script>
		<script type="text/javascript"
	...
	<body
		...
		<div id="header">
			...
			<ul class="menu">
				...
				<li id="newMsg"></li>
				<li class="hot">
					<a href="<c:url value='/admin/app'/>">企业组件</a>
				</li>
			</ul>
		...
		<div id="footer">
			<div class="l">
				EShow开源框架 &copy; 2009&nbsp;&nbsp;技术支持：
				<a href="http://www.daoqun.net" target="_blank">无锡到群软件科技有限公司</a>
			</div>
			<div class="r">
				<a href="http://www.eshow.org.cn" target="_blank">开发博客</a>&nbsp;&nbsp;|&nbsp;&nbsp;

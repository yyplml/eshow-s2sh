...
<head>
	<title>${view.user.nickname}的微博</title>
   		...
   		<div class="wrapper">
        	...
        	<div class="banner"><img src="<c:url value='/images/twitter.jpg'/>" /></div>
               <div id="content">
						<ul class="mainTab">
							<li >
								<a href="<c:url value='/twitter'/>"  class="bg_a">大家的微博 </a> </span>
							</li>
							<li>
							...
							<ul>
								<li id="twitter${id}">
									...
									<div class="cont left">
										...
										<div class="contxt left"><div> <a href="<c:url value='/twitter/workmate/${user.id}'/>" style="text-decoration: none; color:green;"><strong>${user.nickname}:&nbsp;&nbsp;</strong></a>${content}</div>
										<div class="info">
										<div class="msg"><s:date
												name='addTime' format="yyyy-MM-dd HH:mm" /> <div class="tips"> <c:if test="${user.id == myid}">&nbsp;&nbsp;|&nbsp;&nbsp;</c:if><a

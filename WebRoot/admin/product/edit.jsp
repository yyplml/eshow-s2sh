								...
								<div id="mainTab">
									<ul>
										<li class="on"><span class="txt6"><a
												href="<c:url value='/admin/product'/>">产品列表</a> </span></li>
										<li><span class="txt6"><a
												href="<c:url value='/admin/productCategory'/>">产品分类</a> </span></li>
										<li class="navtxt"><a
											href="<c:url value='/admin/product/add'/>"
											style="text-decoration:none;">添加产品</a></li>
									</ul>
								</div>
								<div id="productEdit">
									<s:form id="productForm" action="product!update.html"
										...
										<p>
											<span class="l">产品名称:&nbsp;</span> <input name="product.name"
										...
										<p>
											...
											<s:action name="productCategory!search"
												id="productCategoryList" executeResult="false" />
											<select id="productCategoryId" name="productCategoryId">
												<s:iterator
													value="%{#productCategoryList.productCategories}"
													status="rowStatus">
													<option value="${id}"
										...
										<p>
											<span class="l">选择图片:&nbsp;</span> <span class="1"> <input
												type="file" name="file" size="38"
												class="inputtext text-input validate['required']" /> </span>
										</p>
										<p>
											<span class="l">产品内容:&nbsp;</span> <span class="r">&nbsp;
												<script type="text/javascript">
													KE.show({
														id : 'ke-text'
													});
												</script> <textarea id="ke-text" name="product.content"
													style="width: 600px; height: 300px;">${view.product.content}</textarea>
											</span>
										</p>
										<p align="center">

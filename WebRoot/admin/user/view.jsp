				...
				<div id="content">
					...
					<div id="mainTab">
						<ul>
							...
							<li class="on">
								<span class="txt6"><a
									href="<c:url value='/admin/user/edit'/>"> <c:if
											test="${view.user.id !=myid}">${view.user.nickname}的信息</c:if>
										<c:if test="${view.user.id ==myid}">我的信息</c:if> </a> </span>
							</li>
							<li>
								<span class="txt6"><a

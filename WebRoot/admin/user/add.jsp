		...
		<div class="row-fluid">
			...
			<div class="span10">
				<ul class="breadcrumb">
					...
					<li><a href="${ctx}/admin/user/">${title}</a> <span
									...
									<div class="controls">
										<select id="bloodType" style="width: 8em;" name="user.bloodType">
											<option value="1" ${view.user.marital==1?
												"selected='selected'":""}>A型</option>
											<option value="2" ${view.user.marital==2?
												"selected='selected'":""}>B型</option>
											<option value="3" ${view.user.marital==3?
												"selected='selected'":""}>AB型</option>
											<option value="4" ${view.user.marital==4?
												"selected='selected'":""}>O型</option>
										</select>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="marital" style="width: 8em;" name="user.marital">
											<option value="1" ${view.user.marital==1?
												"selected='selected'":""}>单身</option>
											<option value="2" ${view.user.marital==2?
												"selected='selected'":""}>已婚</option>
											<option value="3" ${view.user.marital==3?
												"selected='selected'":""}>恋爱</option>
											<option value="4" ${view.user.marital==4?
												"selected='selected'":""}>离异</option>
										</select>
									</div>
								</div>
								<div class="control-group">

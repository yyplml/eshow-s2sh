		...
		<div class="row-fluid">
			...
			<div class="span10">
				...
				<div class="well com">
					...
					<ul class="phto-list clearfix">
						<li><img border="0" src="http://i.mmcdn.cn/simba/img/T1uL0FXq8gXXb1upjX.jpg"
							width="300px" height="250px">
							<p>
								<a class="btn btn-mini" href="javascript:;" id="phto-s"><i
									class="icon-pencil"></i>修改</a> <a class="btn btn-mini" href="#"><i
									class="icon-pencil"></i>修改</a> <a class="btn btn-mini" href="#"><i

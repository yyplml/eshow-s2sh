				...
				<div class="well com">
					<div class="page-header">
						...
						<ul id="myTab" class="nav nav-tabs">
							...
							<li><a data-toggle="tab" href="<c:url value='/admin/blog/add'/>">添加日志</a></li>
							<li class="active"><a data-toggle="tab" href="<c:url value='/admin/blog/mine'/>">我的日志</a></li>
					...
					<div id="content">
						<ul id="myTab" class="nav nav-tabs">
							<li class="active"><a
								href="<c:url value='/admin/blog/mine'/>" data-toggle="tab">我的日志</a>
							</li>
							<li><a href="<c:url value='/admin/category'/>"
								data-toggle="tab">分类管理</a></li>
							<li class="navtxt"><a
								href="<c:url value='/admin/blog/add'/>" data-toggle="tab">发表日志</a>
							</li>
							<li class="bnt1"><a href="<c:url value='/admin/topic'/>"
								data-toggle="tab">讨论区</a></li>
						</ul>
						<div id="column">
							<div id="blog">
								<div class="subtitle">
